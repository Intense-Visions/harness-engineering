...
argument-hint: '[--path <path>] [--files <files>] [--exclude-dirs <exclude-dirs>] [--max-files <max-files>]'
allowed-tools:
  - Bash
  - Read
  - Glob
...
<execution_context>
@agents/skills/claude-code/docs-craft/SKILL.md
@agents/skills/claude-code/docs-craft/skill.yaml
</execution_context>
