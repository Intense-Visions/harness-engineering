...
argument-hint: '[--path <path>] [----fleets <--fleets>] [----slots <--slots>] [----max-fleets <--max-fleets>] [----wall-clock <--wall-clock>] [----report-only <--report-only>] [----dry-run <--dry-run>] [----lease-seconds <--lease-seconds>] [----no-claim <--no-claim>]'
allowed-tools:
  - Bash
  - Read
  - Glob
