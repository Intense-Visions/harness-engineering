...
- verify: Independently confirm each returned branch has a plan artifact plus a committed provenance file, a scope-correct closing keyword in the PR body, and is CI-green across all target operating systems plus the project's required checks — never by subagent self-report
