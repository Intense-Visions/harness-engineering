...
members:
  [
    'config.test.ts',
    'loader.test.ts',
    'orchestrator-context.test.ts',
    'orchestrator.workflow-dispatch.test.ts',
    'routing-config-schema.test.ts',
    'routing-cross-field.test.ts',
    'routing-isolation-schema.test.ts',
    'routing-warnings.test.ts',
    'schema.test.ts',
    'skill-catalog.test.ts',
    'spec-b-phase-2-acceptance.test.ts',
    'workflow-for.test.ts',
  ]
---
