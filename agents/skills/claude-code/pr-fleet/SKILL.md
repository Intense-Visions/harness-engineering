...
| "CI is green on Linux, land it"                                                            | Green on one OS is not green. Landing requires all target operating systems plus the project's required checks. A subset-red PR is reported not-land-ready, not landed. |
