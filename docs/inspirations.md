...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Mechanical + Behavioral** | The only framework combining linter-enforced constraints (10 ESLint rules, layer boundary enforcement) with behavioral guidance (49 skills, 12 personas). Other frameworks do one or the other — harness does both. |
