...
```markdown
# packages/cli/src/slash-commands/__tests__/fixtures/valid-skill/SKILL.md
# Test Skill
...
```typescript
import { createGenerateSlashCommandsCommand, generateSlashCommands } from './commands/generate-slash-commands';
