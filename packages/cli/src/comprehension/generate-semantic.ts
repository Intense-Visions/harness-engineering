...
// The run-boundary reentrancy guard now lives in `@harness-engineering/core`
// (promoted alongside the compile driver so library consumers share it). Re-
// exported here for back-compat — every existing importer keeps working.
export {
  REENTRANCY_ENV,
