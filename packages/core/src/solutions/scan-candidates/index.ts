...
export { computeHotspots, computeStableHotspots } from './hotspot';
...
export type {
  Hotspot as ScanHotspot,
  HotspotOptions as ScanHotspotOptions,
  ScoredHotspot as ScanScoredHotspot,
  StableHotspotOptions as ScanStableHotspotOptions,
} from './hotspot';
