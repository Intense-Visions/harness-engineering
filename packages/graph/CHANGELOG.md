...
- 0dda585: Fix `ingestSolutions` rejecting every solution doc whose frontmatter uses quoted scalars.
...
- a05b6de: Skip plain-git worktree containers (`.git-worktrees/`, `.worktrees/`) during source-file walking.
...
- 21325cf: fix(graph): give the #940 extractor integration test a Windows-safe per-test timeout
